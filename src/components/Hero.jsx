          ...
          <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
            ...
            >
              ...
              <button
                ...
                className="px-5 py-2.5 bg-[#CCFF00] hover:bg-[#b5e600] text-[#064E3B] rounded-xl text-xs font-extrabold shadow-sm transition-all whitespace-nowrap cursor-pointer"
              >
                Find Now
              </button>
            </motion.div>
            ...
            <motion.div
              ...
              className="grid grid-cols-3 gap-2 pt-4 max-w-md mx-auto lg:mx-0 border-t border-emerald-100"
            >
              <div className="flex items-center gap-1.5 text-xxs text-gray-600 justify-center lg:justify-start">
                <ShieldCheck className="w-3.5 h-3.5 text-[#10B981]" />
                <span>Healthy Roots Guarantees</span>
              </div>
              <div className="flex items-center gap-1.5 text-xxs text-gray-600 justify-center lg:justify-start">
                <BadgePercent className="w-3.5 h-3.5 text-[#10B981]" />
                <span>Value Bundle Offers</span>
              </div>
              <div className="flex items-center gap-1.5 text-xxs text-gray-600 justify-center lg:justify-start">
                <Compass className="w-3.5 h-3.5 text-[#10B981]" />
                <span>Kerala District Shipping</span>
              </div>
            </motion.div>
          </div>
            ...
            >
              ...
              <div className="relative bg-white p-4.5 rounded-[40px] shadow-2xl border border-emerald-50 overflow-hidden group">
                ...
                <div className="absolute bottom-8 left-8 right-8 bg-white/95 backdrop-blur-md px-5 py-4 rounded-2xl shadow-lg border border-emerald-50 flex items-center justify-between">
                  ...
                  <div className="h-10 w-10 bg-[#064E3B] text-[#CCFF00] rounded-xl flex items-center justify-center font-bold">
                    Go!
                  </div>
                </div>

                <div className="absolute top-8 right-8 bg-[#CCFF00] text-[#064E3B] px-3 py-1 rounded-full text-xs font-extrabold shadow-md flex items-center gap-1">
                  <span>★</span>
                  <span>Premium</span>
                </div>
              </div>
              ...
              >
                <div className="flex items-center gap-2 mb-1.5">
                  <span className="bg-white/20 p-1 rounded-lg text-[#CCFF00] text-sm">🌱</span>
                  <span className="text-[10px] uppercase font-bold tracking-wider text-[#CCFF00]">Rosemary Care</span>
                </div>
